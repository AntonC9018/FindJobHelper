...
{
    [Fact]
    public void Load_AcceptsAbsoluteUsageDllPath()
    {
        var result = ExperienceDatabaseProviderLoader.Load(UsageDllPath);
    ...
    {
        var relativePath = Path.GetRelativePath(Environment.CurrentDirectory, UsageDllPath);
    ...
    private static string UsageDllPath =>
